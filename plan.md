...
- [x] Unnötigen oder toten Code weiter entfernen: sichere Treffer, verwaiste Übergangskomponenten, Legacy-Promptprofile, ungenutzte Wrapper, Typen und Hilfsfunktionen wurden nach Verwendungsprüfung entfernt; `audit:maintainability` meldet aktuell keine ungenutzten benannten Exporte. Verwaiste CSS-Klassen und nicht erreichbare Routen bleiben als separate UI-/Routing-Prüfung offen.
- [x] Eindeutig verwaiste Bild-/Trainingsübergänge und Hilfsfunktionen entfernt: das alte Illustration-v1-Profil, die ungenutzte Phasenkarte, der nicht eingebundene Builder-Resume-Link sowie unreferenzierte Body-Region-/Bildkarten-Helfer sind gelöscht; verbleibende Audit-Treffer brauchen eine separate Verwendungsprüfung.
