...
- [x] Korrigiertes Batch 2 verarbeitet: 35 weitere lokale Bilder sind als `club_created`/`pending` importiert, 7 vorhandene freigegebene Medien blieben geschützt und 38 mehrdeutige Zuordnungen wurden für das Review zurückgestellt; der Initial-DuckDB-Snapshot wurde mit 92 lokalen Bildmedien neu gebaut.
