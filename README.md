...
- Medienbereinigung: 20 benannte, portable Nutzerbilder sind als freigegebene Primärmedien importiert. Weitere 72 Bilder aus den Codex-Manifesten wurden als lokale `club_created`-Medien mit Reviewstatus `pending` ergänzt; vorhandene freigegebene Medien bleiben geschützt und 38 unklare Zuordnungen des korrigierten Batch 2 wurden nicht geraten. Der deploybare Initialstand enthält damit 92 lokale Bildmedien.
