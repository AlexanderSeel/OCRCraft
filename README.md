...
- Medienbereinigung: 20 benannte, portable Nutzerbilder sind als freigegebene Primärmedien importiert. Weitere 149 Bilder aus den Codex-Manifesten wurden als lokale `club_created`-Medien mit Reviewstatus `pending` ergänzt; vorhandene freigegebene Medien bleiben geschützt und 84 unklare Zuordnungen aus Batch 2 bis Batch 4 wurden nicht geraten. Der deploybare Initialstand enthält damit 169 lokale Bildmedien.
