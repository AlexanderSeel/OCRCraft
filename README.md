...
- Datenbank-Release 1.0: 85 nummerierte Migrationen bis Version 86 werden über [`src/server/db/initial-v1.sql`](./src/server/db/initial-v1.sql) als atomare Fresh-Install-Baseline ausgeliefert; bestehende Datenbanken bleiben upgradefähig.
