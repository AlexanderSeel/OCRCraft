...
- Datenbank-Release 1.0: 89 nummerierte Migrationen bis Version 90 werden über [`src/server/db/initial-v1.sql`](./src/server/db/initial-v1.sql) als atomare Fresh-Install-Baseline ausgeliefert; bestehende Datenbanken bleiben upgradefähig.
