...
- Medienbereinigung: 20 benannte, portable Nutzerbilder sind als freigegebene Primärmedien importiert. Weitere 114 Bilder aus den Codex-Manifesten wurden als lokale `club_created`-Medien mit Reviewstatus `pending` ergänzt; vorhandene freigegebene Medien bleiben geschützt und 54 unklare Zuordnungen aus Batch 2 und Batch 3 wurden nicht geraten. Der deploybare Initialstand enthält damit 134 lokale Bildmedien.
