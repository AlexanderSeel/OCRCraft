  ...
  return <>
    ...
    {open ? <Dialog eyebrow="Identität" onClose={() => setOpen(false)} title="Vereinskonto anmelden">
      <form action={action} className="grid gap-3">
        <p className="text-sm leading-6 text-[var(--muted)]">Melde dich mit E-Mail und Passwort an. Der Vereinszugangscode ist nur als lokaler Bootstrap-Fallback vorgesehen.</p>
