...
export const TRAINING_TEMPLATES: readonly TrainingTemplateDefinition[] = [
  ...
  template({
    key: "adult-ocrfra-club-obstacle-circuit",
    titleDe: "OCRFRA Club-Obstacle Circuit",
    titleEn: "OCRFRA Club Obstacle Circuit",
    descriptionDe: "Technikzirkel an freigegebenen OCRFRA-Hindernissen mit klaren Levels, Sicherheitszonen und Alternativen.",
    descriptionEn: "Technique circuit using approved OCRFRA obstacles with clear levels, safety zones and alternatives.",
    audience: "adults", minAge: 18, maxAge: null, defaultParticipants: 12, durationMinutes: 75,
    focus: "parcours", goals: ["OCR-Technik", "Grip", "Koordination"], bodyRegions: ["full-body", "forearms-grip", "core"],
    formats: ["technique", "circuit"], location: "mixed", intensity: "technique",
    structureDe: { warmup: "Schulter, Griff, Fußarbeit und Abstiegstechniken vorbereiten.", main: "Irish Table, Weaver, Balance, Wand und Rig nur nach lokaler Freigabe in Qualitätsrunden bearbeiten.", cooldown: "Unterarme, Schulter und Hüfte entlasten; Technik kurz reflektieren." },
    materialHintsDe: ["freigegebene OCRFRA-Hindernisse", "Matten/Fallschutz", "Warte- und Ausstiegsmarker", "bodennahe Fallbacks"],
  }),
  template({
    key: "youth-ocrfra-obstacle-foundations",
    titleDe: "OCRFRA Hindernis-Grundlagen Youth",
    titleEn: "OCRFRA Youth Obstacle Foundations",
    descriptionDe: "Jugendgerechte OCR-Grundlagen mit niedrigen Varianten, direkter Aufsicht und ohne Zeitdruck auf schwierige Hindernisse.",
    descriptionEn: "Youth OCR foundations with low variations, direct supervision and no time pressure on difficult obstacles.",
    audience: "youth", minAge: 12, maxAge: 17, defaultParticipants: 12, durationMinutes: 60,
    focus: "parcours", goals: ["OCR-Technik", "Balance", "Koordination"], bodyRegions: ["full-body", "core", "ankles-feet"],
    formats: ["technique", "circuit"], location: "mixed", intensity: "technique",
    structureDe: { warmup: "Bodennahe Griff-, Balance-, Crawl- und Step-up-Aufgaben mit Stoppsignal.", main: "Kurze, beaufsichtigte Technikfenster an freigegebenen niedrigen Varianten; bei Unsicherheit sofort Fallback nutzen.", cooldown: "Locker auslaufen, Sprunggelenk/Schulter mobilisieren und sichere Technik benennen." },
    materialHintsDe: ["niedrige freigegebene Varianten", "Matten", "Wartezonen", "Bodenlinien oder niedrige Bänke"],
  }),
  template({
