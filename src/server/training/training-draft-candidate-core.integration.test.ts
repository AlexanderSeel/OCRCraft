...
async function createFixture() {
  ...
  await connection.run(`
    ...
    INSERT INTO exercises VALUES
      ('kids-carry','carry-lift','main','low',8,false,true,true,true,240),
      ('adult-wall','ocr-skill','main','high',16,false,false,true,true,300),
      ('archived','strength','main','low',NULL,true,true,true,true,180);
    ...
    INSERT INTO exercise_details VALUES
      ('kids-carry','de','Sicheres Tragen lernen.','Aufrecht und kontrolliert.','Leicht tragen.','Standard tragen.','Weiter tragen.'),
      ('kids-carry','en','Learn safe carrying.','Tall and controlled.','Light carry.','Standard carry.','Longer carry.');
