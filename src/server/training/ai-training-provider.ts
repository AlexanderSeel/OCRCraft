...
function buildPromptPayload(context: AiTrainingGenerationContext) {
  return {
    ...
    request: {
      ...
      mainPartExerciseCounts: context.request.mainPartExerciseCounts,
      mainPartProgramming: context.request.mainPartProgramming,
      ...
      groupSplitCount: context.request.groupSplitCount,
