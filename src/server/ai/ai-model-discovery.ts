...
const knownModels: Readonly<Record<AiProviderKind, readonly AiModelOption[]>> = {
  openai: [
    { id: "gpt-6-astra", label: "GPT-6 Astra", supportsText: true, supportsImage: false, source: "known" },
  ...
  gemini: [
    ...
    { id: "gemini-3.1-pro", label: "Gemini 3.1 Pro", supportsText: true, supportsImage: false, source: "known" },
  ],
  anthropic: [
    ...
    { id: "claude-haiku-4-5", label: "Claude Haiku 4.5", supportsText: true, supportsImage: false, source: "known" },
  ],
  "openai-compatible": [],
};
