...
-- Source migration: 085_portable_training_equipment_followup.sql
...
-- Source migration: 086_portable_catalog_review_completion.sql
...
-- Source migration: 089_finalize_blocked_studio_reviews.sql
INSERT OR IGNORE INTO tags (id,label_de,label_en)
VALUES ('fitnessstudio','Fitnessstudio','Gym');
...
-- Source migration: 091_ocr_skill_matrix_club_dimension_review.sql
...
FROM exercises e
JOIN (VALUES
  ('club-irish-table','wall-vault','primary'),('club-irish-table','pull-support','secondary'),('club-irish-table','balance-precision','secondary'),
  ('club-weaver','traverse','primary'),('club-weaver','grip-hang','secondary'),('club-weaver','balance-precision','secondary'),
  ('club-rotating-rig-elements','swing-rotation','primary'),('club-rotating-rig-elements','traverse','secondary'),('club-rotating-rig-elements','grip-hang','secondary'),
  ('club-multirig-ring-traverse','traverse','primary'),('club-multirig-ring-traverse','grip-hang','secondary'),('club-multirig-ring-traverse','swing-rotation','secondary'),
  ('club-incline-wall-traverse','wall-vault','primary'),('club-incline-wall-traverse','pull-support','secondary'),('club-incline-wall-traverse','balance-precision','secondary'),
  ('club-tire-obstacle-transit','balance-precision','primary'),('club-tire-obstacle-transit','locomotion-transition','secondary'),
  ('club-olympus','traverse','primary'),('club-olympus','grip-hang','secondary'),('club-olympus','swing-rotation','secondary'),
  ('club-escaladierwand','wall-vault','primary'),('club-escaladierwand','pull-support','secondary'),
  ('club-inverse-wall','wall-vault','primary'),('club-inverse-wall','pull-support','secondary'),
  ('club-balance-beam','balance-precision','primary'),
  ('club-slackline','balance-precision','primary'),
  ('club-anchor-chain-drag','drag-pull','primary'),('club-anchor-chain-drag','strength-conditioning','secondary'),
  ('club-atlas-stone-carry','carry-load','primary'),('club-atlas-stone-carry','strength-conditioning','secondary')
) AS v(seed_key,skill_id,emphasis) ON e.seed_key=v.seed_key;

INSERT OR IGNORE INTO club_obstacle_review_state (exercise_id,dimensions_status,dimensions_note)
SELECT e.id,'review','Lokale Höhe/Spannweite/Reichweite bleibt bis zur expliziten Vereinsmessung unbestätigt.'
FROM exercises e
WHERE e.seed_key LIKE 'club-%' AND e.exercise_type='obstacle';
...
INSERT INTO schema_migrations (version, name) VALUES
  ...
  (91, 'ocr_skill_matrix_club_dimension_review');
