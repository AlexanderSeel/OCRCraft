        ...
        {activeTab === "settings" ? (
          <>
            <section id="identity" className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-[var(--shadow-card)] sm:p-6">
              ...
              <div className="mt-4 grid gap-2">{appUsers.map((user) => <form action={updateUserAction} className="grid gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface-subtle)] p-3 md:grid-cols-[1fr_1fr_auto_auto] md:items-end" key={user.id}>
